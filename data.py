...
SEED_WORKERS = [
...

    {
        ...
        {
        "worker_id": "DW-1111", "name": "Harpreet Kaur", "age": 35,
        "gender": "Female", "skill": "Cook",
        "phone": "90XXXXXX19", "phone_type": "Personal",
        "nationality": "Indian", "state": "Punjab",
        "reg_mode": "Self",
        "docs": ["Aadhaar Card", "Address Proof", "Photograph", "Skill Certification"],
        "references": [{"name": "Simran Kaur", "phone": "9814000001"}],
        "police_status": "Verified",
        "trust_score": 87,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Verified", "Skill Cert": "Verified"},
        "flagged": False,
        "registered_at": "2024-11-25 10:15",
    },

    {
        "worker_id": "DW-1112", "name": "Ganesh Iyer", "age": 44,
        "gender": "Male", "skill": "Driver",
        "phone": "90XXXXXX20", "phone_type": "Personal",
        "nationality": "Indian", "state": "Tamil Nadu",
        "reg_mode": "Employer", "employer_aadhaar": "XXXX-XXXX-8899",
        "docs": ["Driving License", "Aadhaar Card", "Address Proof"],
        "references": [],
        "police_status": "Verified",
        "trust_score": 82,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Verified", "Skill Cert": "Verified"},
        "flagged": False,
        "registered_at": "2024-12-05 08:50",
    },

    {
        "worker_id": "DW-1113", "name": "Babulal Meena", "age": 38,
        "gender": "Male", "skill": "Gardener",
        "phone": "90XXXXXX21", "phone_type": "Family / Shared",
        "nationality": "Indian", "state": "Rajasthan",
        "reg_mode": "Agent", "agent_id": "AGT-RJ-007",
        "docs": ["Photograph"],
        "references": [],
        "police_status": "Pending",
        "trust_score": 40,
        "verification": {"Identity": "Partial", "Address": "Not Added", "Police": "Pending", "Skill Cert": "Not Added"},
        "flagged": False,
        "registered_at": "2025-03-08 09:20",
    },

    {
        "worker_id": "DW-1114", "name": "Rekha Patil", "age": 31,
        "gender": "Female", "skill": "Cleaner",
        "phone": "90XXXXXX22", "phone_type": "Personal",
        "nationality": "Indian", "state": "Maharashtra",
        "reg_mode": "Self",
        "docs": ["Aadhaar Card", "Photograph"],
        "references": [],
        "police_status": "Not Verified",
        "trust_score": 50,
        "verification": {"Identity": "Verified", "Address": "Pending", "Police": "Not Verified", "Skill Cert": "Not Added"},
        "flagged": False,
        "registered_at": "2025-01-18 14:10",
    },

    {
        "worker_id": "DW-1115", "name": "John Mathew", "age": 46,
        "gender": "Male", "skill": "Caretaker",
        "phone": "90XXXXXX23", "phone_type": "Personal",
        "nationality": "Indian", "state": "Kerala",
        "reg_mode": "Self",
        "docs": ["Aadhaar Card", "Medical Certificate", "Photograph", "Bank Details"],
        "references": [{"name": "Thomas Mathew", "phone": "9847000022"}],
        "police_status": "Verified",
        "trust_score": 90,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Verified", "Skill Cert": "Verified"},
        "flagged": False,
        "registered_at": "2024-10-30 12:40",
    },

    {
        "worker_id": "DW-1116", "name": "Sita Gurung", "age": 28,
        "gender": "Female", "skill": "Maid",
        "phone": "90XXXXXX24", "phone_type": "Personal",
        "nationality": "Nepal", "country": "Nepal",
        "reg_mode": "Employer",
        "docs": ["Citizenship Card", "Address Proof"],
        "references": [],
        "police_status": "Pending",
        "trust_score": 62,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Pending", "Skill Cert": "Not Added"},
        "flagged": False,
        "registered_at": "2025-02-25 10:05",
    },

    {
        "worker_id": "DW-1117", "name": "Rafiq Ahmed", "age": 41,
        "gender": "Male", "skill": "Plumber",
        "phone": None, "phone_type": "No Phone",
        "nationality": "Indian", "state": "Assam",
        "reg_mode": "Agent", "agent_id": "AGT-AS-004",
        "docs": ["Photograph"],
        "references": [],
        "police_status": "Not Verified",
        "trust_score": 28,
        "verification": {"Identity": "Partial", "Address": "Not Added", "Police": "Not Verified", "Skill Cert": "Not Added"},
        "flagged": False,
        "registered_at": "2025-03-11 08:00",
    },

    {
        "worker_id": "DW-1118", "name": "Tenzin Wangchuk", "age": 33,
        "gender": "Male", "skill": "Cook",
        "phone": "90XXXXXX25", "phone_type": "Personal",
        "nationality": "Bhutan", "country": "Bhutan",
        "reg_mode": "Employer",
        "docs": ["Citizenship Card"],
        "references": [],
        "police_status": "Pending",
        ...
        "verification": {"Identity": "Verified", "Address": "Pending", "Police": "Pending", "Skill Cert": "Not Added"},
        "flagged": False,
        "registered_at": "2025-02-14 11:45",
    },

    {
        "worker_id": "DW-1119", "name": "Meenakshi Das", "age": 36,
        "gender": "Female", "skill": "Babysitter",
        "phone": "90XXXXXX26", "phone_type": "Personal",
        "nationality": "Indian", "state": "West Bengal",
        "reg_mode": "Self",
        "docs": ["Aadhaar Card", "Address Proof", "Skill Certification"],
        "references": [{"name": "Soma Das", "phone": "9831000001"}],
        "police_status": "Verified",
        "trust_score": 84,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Verified", "Skill Cert": "Verified"},
        "flagged": False,
        "registered_at": "2024-12-12 13:25",
    },

    {
        "worker_id": "DW-1120", "name": "Vikram Singh", "age": 39,
        "gender": "Male", "skill": "Security Guard",
        "phone": "90XXXXXX27", "phone_type": "Personal",
        "nationality": "Indian", "state": "Madhya Pradesh",
        "reg_mode": "Employer", "employer_aadhaar": "XXXX-XXXX-6677",
        "docs": ["Aadhaar Card", "Photograph"],
        "references": [],
        "police_status": "Verified",
        "trust_score": 72,
        "verification": {"Identity": "Verified", "Address": "Verified", "Police": "Verified", "Skill Cert": "Not Added"},
        "flagged": True,  # flagged case (important edge case)
        "registered_at": "2025-01-05 07:30",
    }
]
